...
sys.path.insert(0, '{}/../'.format(myPath))
...
class MASCryptTest(unittest.TestCase):
    ...
    def test_addition_bin(self):
        ...
        a = '1000100001100000001111010011101000110110100001100000001100001010101'
        b = '100011111001101000101010011110010111001101110'
        res = '0b1000100001100000001111110111100010011111001011111110100011011000011'
        self.assertEqual(
            res,
    ...
    def test_substraction_bin(self):
        ...
        a = '111011100100101111000000110101111001010011100111101110101101000010111100'
        b = '1110001101000010110000100101110000111100001010101101100110011011'
        res = '0b111011010110100001111110000101010011100010101011100011111111011100100001'
        self.assertEqual(
            res,
    ...
    def test_substraction_mod_bin(self):
        ...
        a = '111011100100101111000000110101111001010011100111101110101101000010111100'
        b = '1110001101000010110000100101110000111100001010101101100110011011'
        n = '1100101100111100101010110011011001100011111111100110010010110011001011'
        res = '0b1000100010101111010010110111101101010010101101001010110100001111110101'
        self.assertEqual(
            res,
    ...
    def test_multiplication_bin(self):
        ...
        res = '0b10110001110100010000111000111110110101000000010110110001010111011000010001101111000110000101100000001010111110010101001'
        self.assertEqual(
            res,
    ...
    def test_multiplication_mod_bin(self):
        ...
        a = '10000101100110011000110100010111111111110101010011100010110111011'
        b = '1010101001011101000011001011101111010100100111011101011'
        n = '10010111110001101100110111101011101100010100110101101011010100010101000001111111101010'
        res = '0b1111101011111111100011111100101010110111010100011011100101100100100001101110100011'
        self.assertEqual(
            res,
    ...
    def test_division_bin(self):
        ...
        a = '110000001110010000111000001010111011010111010100011100111011101101010100001100011101001100'
        b = '10000111010011111111011111111000111010010011000011111000110010000110100001001100101111110'
        res = '0b0100000000000110110011101111010110101010110001111100110100001010'
        self.assertEqual(
            res,
    ...
    def test_square_root_bin(self):
        ...
        a = '1000110111000101000111011001010011011101100001010110000110001000110111010100010010'
    ...
    def test_primitive_root_bin(self):
        ...
        a = '10000011'
        res = ['0b10000000', '0b1111111', '0b1111110', '0b1111100', '0b1111010', '0b1111000', '0b1110111', '0b1110110', '0b1110100', '0b1110011', '0b1101111', '0b1101110', '0b1101010', '0b1101000', '0b1100111', '0b1100010', '0b1100001', '0b1100000', '0b1011111', '0b1011101', '0b1011010', '0b1011000', '0b1010111', '0b1010101', '0b1010011', '0b1010010', '0b1001100', '0b1001000', '0b1000011', '0b1000010', '0b111001', '0b111000', '0b110110', '0b110010', '0b101000', '0b100101', '0b11111', '0b11110', '0b11101', '0b11010', '0b10111', '0b10110', '0b10001', '0b1110', '0b1010', '0b1000', '0b110', '0b10']
        self.assertEqual(
            res,
    ...
    def test_primitive_root_dec(self):
        ...
        a = '131'
        res = [128, 127, 126, 124, 122, 120, 119, 118, 116, 115, 111, 110, 106, 104, 103, 98, 97, 96, 95, 93, 90, 88, 87, 85, 83, 82, 76, 72, 67, 66, 57, 56, 54, 50, 40, 37, 31, 30, 29, 26, 23, 22, 17, 14, 10, 8, 6, 2]
        self.assertEqual(
            res,
    ...
    def test_primitive_root_hex(self):
        ...
        a = '83'
        res = ['0x80', '0x7f', '0x7e', '0x7c', '0x7a', '0x78', '0x77', '0x76', '0x74', '0x73', '0x6f', '0x6e', '0x6a', '0x68', '0x67', '0x62', '0x61', '0x60', '0x5f', '0x5d', '0x5a', '0x58', '0x57', '0x55', '0x53', '0x52', '0x4c', '0x48', '0x43', '0x42', '0x39', '0x38', '0x36', '0x32', '0x28', '0x25', '0x1f', '0x1e', '0x1d', '0x1a', '0x17', '0x16', '0x11', '0xe', '0xa', '0x8', '0x6', '0x2']
        self.assertEqual(
            res,
    ...
    def test_xor_bin(self):
        ...
        a = '0011101011100010001001010001000110011100001111010000101111010001101110100100011000110110111110101100'
        b = '1011100110000101010001111010100001011101101101100111010101101100000000110110000010110101100011011111'
        res = '0b1000001101100111011000101011100111000001100010110111111010111101101110010010011010000011011101110011'
        self.assertEqual(
            res,
            lxor.XOR(2).xor(a, b)
        )
    ...
    def test_mod_inverse_bin(self):
        ...
        n = '110101011110000100100110000000001101100111100101100100010100100011100001010111100000110100'
        res = '0b111010001001001011011000000100101001000110101001101101011011101111001110010010101101001'
        self.assertEqual(
            res,
    ...
    def test_exponentiation_bin(self):
        ...
        b = '1100'
        res = '0b1101001001001010110110010001101100000011100001100001011110000110110000001100111111010010011010010111001100111001101000101101101010010010000000001110010000001000110011011000101111100111111110111101000110010011100000001000000000000'
        self.assertEqual(
            res,
    ...
    def test_exponentiation_hex(self):
        ...
        a = '85682'
        b = 'C'
        res = '0x1A495B236070C2F0D819FA4D2E67345B52401C8119B17CFF7A32701000'.lower()
        self.assertEqual(
            res,
    ...
    def test_exponentiation_mod_bin(self):
        ...
        a = '10000101011010000010'
        b = '1100'
        n = '1000100110000001100101000101100101101101101101101111011010001101001101010000000'
        res = '0b100100111011001011000001000101111111111000000101101000010001010010010000000'
        self.assertEqual(
            res,
    ...
    def test_mod_bin(self):
        ...
        a = '11011000110001010101001110010011100111100110001001000011111010010101110000110000100000010011000111001111000000110'
        n = '1001001111000001010010111110101110000110110101111011001110111101101010011010100010111101111100000111'
        res = '0b100001000010100010111001110110000001110010010010010110110111111010111001000000101111000011101101000'
        self.assertEqual(
            res,
    ...
    def test_gcd_2_bin(self):
        ...
        a = '101010111011010001101110111001001111010100100100101101110010101100001001001110000110'
        b = '11000011100110001000100000101111110001000101001000000010110011110110011101010000'
        res = '0b10'
        self.assertEqual(
            res,
    ...
    def test_gcd_3_bin(self):
        ...
        a = '101010111011010001101110111001001111010100100100101101110010101100001001001110000110'
        b = '11000011100110001000100000101111110001000101001000000010110011110110011101010000'
        c = '11110110100101010110001000101111011101001000010101110001001000110110100101100111101'
        res = '0b1'
        self.assertEqual(
            res,
    ...
    def test_lcm_2_bin(self):
        ...
        res = '0b11010011110110101101110001010101011101100110100101110110000010110000011011011010'
        self.assertEqual(
            res,
    ...
    def test_lcm_3_bin(self):
        ...
        res = '0b11000100110110100010001111111111000010100100010011000000011111111110010001111100111100100101011011101101001100101110100110010'
        self.assertEqual(
            res,
    ...
    def test_primality_ok_bin(self):
        ...
        a = '10101010011100011101101000001100101001100111001100101110111011111011000000011010101000011100101000010001111110100000001'
        self.assertTrue(
    ...
    def test_primality_ko_bin(self):
        """ Test binary primality. """
        a = '10101110001101111011011010000100100111001101101001010100111011011000010010000100001010000101110000100'
        self.assertFalse(
            lp.Primality(2).is_prime(a)
        )
    ...
    def test_factorization_bin(self):
        ...
        a = '10011001100001101001101000111101101000011110111111101111010000100011011010110010011101111010010'
        res = ['0b11', '0b11', '0b10', '0b111011111', '0b10110010011111', '0b10001110010000010101', '0b1011110001000001000111101001011110011011100011101']
        self.assertEqual(
            res,
    ...
    def test_factorization_hex(self):
        ...
        res = ['0x3', '0x3', '0x2', '0x1df', '0x2c9f', '0x8e415', '0x178823d2f371d']
        self.assertEqual(
            res,
