    ...
    def greatestCommonDivisor(self, *args):
        ...
        Examples:
            :gdc(a, b, c, ..., n):
                ...
                # Standard form:
                lgcd.LogicalGCD(base).greatestCommonDivisor(a, b)

                # Base-2 numeral system or binary:
                lgcd.LogicalGCD(2).greatestCommonDivisor('110100011011', '1111011001')
                # Returns 0b101

                # Base-10 numeral system or ecimal:
                lgcd.LogicalGCD(10).greatestCommonDivisor('3355', '985')
                # Returns 5

                # Base-16 numeral system or hexadecimal:
                lgcd.LogicalGCD(16).greatestCommonDivisor('D1B', '3D9'))
                # Returns 0x5
        '''
